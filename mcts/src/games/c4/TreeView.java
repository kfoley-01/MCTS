...
public class TreeView extends JComponent {
    ...
    HashMap<TreeNodeConnect4, Color> high;

    public TreeView(TreeNodeConnect4 root) {
        this.root = root;
        high = new HashMap<TreeNodeConnect4, Color>();
    }
    ...
    private void draw(Graphics2D g, TreeNodeConnect4 cur, int x, int y, int wFac) {
    ...
    private void drawNode(Graphics2D g, TreeNodeConnect4 node, int x, int y) {
